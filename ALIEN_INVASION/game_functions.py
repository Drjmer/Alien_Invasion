...
def get_no_rows(ai_settings, ship_height, alien_height):
       ...
       no_of_rows=int((available_space_y)/(2*alien_height))-1
       return no_of_rows

def create_alien(ai_settings,screen,aliens,alien_num,row):
          alien=Alien(ai_settings,screen)
...
def update_aliens(ai_settings,stats,screen,sb,ship,aliens,bullets):
     ...
     #Look for alien ship collisions
       ...
       #to check if any aliens hit the bottom 
...
def ship_hit(ai_settings,stats,screen,sb,ship,aliens,bullets):
       #if ship hit by aliem them decrement ship limit by one
...
def check_aliens_bottom(ai_settings,stats,screen,sb,ship,aliens,bullets):
       #to check if aliens have reach the bottom
       screen_rect=screen.get_rect()
       for alien in aliens.sprites():
              if alien.rect.bottom >= screen_rect.bottom:
                     #this is just like if the alien hit the ship
                     ship_hit(ai_settings,stats,screen,sb,ship,aliens,bullets)
                     break
